...
<div class="relative">
  ...
  {#if isOpen}
    <div class="absolute right-0 z-10 mt-2 w-48 rounded-lg border border-gray-200 bg-white shadow-lg">
      <ul>
        {#each sortOptions as option}
          <li>
            <button
              type="button"
              class="w-full text-left cursor-pointer px-4 py-2 hover:bg-gray-100 focus:outline-none"
